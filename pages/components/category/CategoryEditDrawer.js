...
export const CategoryEditDrawer = (props) => {
  ...
  const handleSubmit = () => {
    ...
    if (!formValid) {
      ...
      setLoading(true)
      axios.post(`${process.env.backendURL}/category/update`,data)
      .then(response=>{
...
export default connect(mapStateToProps, {fetchCategories})(CategoryEditDrawer);
