...
export const CourierEditDrawer = (props) => {
  ...
  const [data, setData] = useState({
    ...
    tracking_url:props.data.tracking_url,
  ...
  const handleSubmit = () => {
    setLoading(true)
      axios.post(`${process.env.backendURL}/courier/update`,data)
      .then(response=>{
...
export default connect(mapStateToProps, {fetchCourier})(CourierEditDrawer);
