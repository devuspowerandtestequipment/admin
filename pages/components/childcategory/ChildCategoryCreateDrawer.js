...
export const ChildCategoryCreateDrawer = (props) => {
...
//   }
  ...
  const handleSubmit = () => {
    ...
    if (!formValid) {
      ...
      setLoading(true)
      axios.post(`${process.env.backendURL}/childcategory`,data)
      .then(response=>{
...
export default connect(mapStateToProps, {fetchChildCategories})(ChildCategoryCreateDrawer);
