        ...
        <Form onSubmit={handleSubmit} >
          ...
          {/* <Form.Group>
            <Form.Input
                  ...
                  // presicion={2}
                  fluid
                  name="cart_quantity_min"
                  value={data.cart_quantity_min}
                  onChange={handleUpdate}
                  label="Minimum cart total amount"
                  placeholder="Minimum price"
                  required
                  width={7}
                  disabled={data.check_cart_quantity?false:true}
              />
              <Form.Input
                  type='number'
                  // presicion={2}
                  fluid
                  name="cart_quantity_max"
                  value={data.cart_quantity_max}
                  onChange={handleUpdate}
                  label="Maximum cart total amount"
              ...
              <div className="two wide field">
                <label>Status</label>
                <Switch checkedChildren="Active" unCheckedChildren="Disabled"  value={data.check_cart_quantity}  onClick={(e)=>chnageStatus(e,'check_cart_quantity')} />
              </div>
          </Form.Group>
          ...
          <Form.Group>
              <Form.Input
                type='number'
                fluid
                name="cart_amount_min"
                value={data.cart_amount_min}
                onChange={handleUpdate}
                label="Minimum cart quantity"
                placeholder="Minimum quantity"
                required
                width={7}
                disabled={data.check_cart_amount?false:true}
              />
              <Form.Input
                type='number'
                fluid
                name="cart_amount_max"
                value={data.cart_amount_max}
                onChange={handleUpdate}
              ...
              <div className="two wide field">
                <label>Status</label>
                <Switch checkedChildren="Active" unCheckedChildren="Disabled"  value={data.check_cart_amount}  onClick={(e)=>chnageStatus(e,'check_cart_amount')} />
              </div>
          </Form.Group> */}
