...
export const AttributeEditDrawer = (props) => {
  ...
  const [attributedata, setAttributeDatas] = useState({
    ...
    isvisiblesearch: props.data.isvisiblesearch,
    isconfigproduct: props.data.isconfigproduct,
    datasarray: props.data.datasarray,
    attrbutes_list: props.data.attrbutes_list,

  });


  useEffect(()=>{
    setAttributeDatas(props.data)
  },[props])
  ...
  const handleSubmit = (e) => {
    ...
    if (!formValid) {
      ...
      setLoading(true)
      axios.post(`${process.env.backendURL}/attribute/update`,attributedata)
      .then(response=>{
        ...
        <Form onSubmit={handleSubmit} loading={loading}>
          ...
          {/* {(() => {
                                    ...
                                    switch(attributedata.type) {
                                        case "Single Dropdown": return <InputFields parentfunction={handleChangeCustomInput}  datas={attributedata.datasarray} />;
...
export default connect(mapStateToProps, {fetchAttributes})(AttributeEditDrawer);
