...
export const ShippingRuleAddNew = (props) => {
    ...
    <Form onSubmit={handleSubmit} id='form9856963'>
        ...
        {conditions.name==='price_in_cart' &&
            ...
            />
            <Form.Field width={1}>
                <Button type="primary" onClick={handleSubmit} loading={loading} icon={<PlusOutlined />} className="btnsui" />
            </Form.Field>  
            <Form.Field width={1}>
                <Button type="primary" danger onClick={()=>setShowForm(false)} loading={loading} icon={<DeleteOutlined />} className="btnsui" />
            </Form.Field>       
            </>
        }
    ...
    :
    <>
    <a onClick={()=>setShowForm(true)}>+ Add Rule</a>
    </>
    }
...
export default connect(mapStateToProps, mapDispatchToProps)(ShippingRuleAddNew)