...
export const ShippingruleCreateDrawer = (props) => {
  ...
  const handleSubmit = () => {
    ...
    setLoading(true)
      axios.post(`${process.env.backendURL}/shippingrule`,data)
      .then(response=>{
...
export default connect(mapStateToProps, {fetchShippingRules})(ShippingruleCreateDrawer);
