...
export class UserTabVisitedProducts extends Component {
  ...
  render() {
    ...
    const columns = [
        ...
        //   },
        {
          ...
          key: "name",
          // width: "30%",
          ...this.getColumnSearchPropsCustom(["product_id", "name"],'name')
        },
        {
          title: "Created",
          dataIndex: "createdAt",
        ...
        },
        {
          ...
          render: (data) => (
            <>
              ...
              <DrawerLastVisitedProductInfo data={data} bigButton={true} />
              &nbsp;
    ...
    return (
        <>
            <h5>Total Visited: {filter_reviews.length}</h5>
            <Table
                loading={false}
                size="small"
                columns={columns}
...
export default connect(mapStateToProps, {fetchAllLastVisitedProducts})(UserTabVisitedProducts)