...
export const CouponsEditDrawer = (props) => {
  ...
  const handleSubmit = () => {
    ...
    if (!formValid) {
      ...
      setLoading(true)
      axios.post(`${process.env.backendURL}/coupon/update`,data)
      .then(response=>{
...
export default connect(mapStateToProps, {fetchCoupons})(CouponsEditDrawer);
