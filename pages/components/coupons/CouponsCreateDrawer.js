...
export const CouponsCreateDrawer = (props) => {
  ...
  const handleSubmit = () => {
    ...
    if (!formValid) {
      ...
      setLoading(true)
      axios.post(`${process.env.backendURL}/coupon`,data)
      .then(response=>{
...
export default connect(mapStateToProps, {fetchCoupons})(CouponsCreateDrawer);
