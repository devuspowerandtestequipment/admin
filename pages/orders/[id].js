...
export const View = (props) => {
  ...
  const generateInvoice = () => {
    ...
    var tmp_data={
        ...
        amount_subtotal:customPrice.priceShow(data.amount_subtotal),
        amount_taxes:customPrice.priceShow(data.amount_taxes),
        amount_discount:customPrice.priceShow(data.amount_discount),
        amount_shipping:customPrice.priceShow(data.amount_shippingrule),
        amount_shipping_method:customPrice.priceShow(data.amount_shipping),
        amount_shipping_method_name:data.shipping_method.name,


        coupon:coupon,
        coupon_value:couponvalue,
        amount_total:customPrice.priceShow(data.amount_total_final),

        amount_total_final:customPrice.priceShow(data.amount_total_final),
    ...
    <Body>
        ...
        <Content style={{ margin: "0 16px" }}>
            ...
            <PageHeader
                ...
                extra={[
                    props.auth && props.auth.admin_role && //<===Order update status role check
                        props.auth.admin_role.order_record_update_status &&
                    ...
                    props.auth && props.auth.admin_role && //<===Order invoice download role check
                        props.auth.admin_role.order_record_invoice &&
                            data.invoice_pdf &&
                                <DownloadInvoice invoice_pdf={data.invoice_pdf} order_id={data.order_id} />,
                    
                    props.auth && props.auth.admin_role && //<===Order delete role check
                        props.auth.admin_role.order_record_delete &&            
                            <Popconfirm
            ...
            <Grid>
                ...
                <Grid.Column mobile={16} tablet={16} computer={12}>
                    ...
                    {props.auth && props.auth.admin_role && //<===Order update status (Order approve) role check
                        props.auth.admin_role.order_record_update_status &&
                            data.order_status==='1' && 
                            <>
                            <Alert
                    ...
                    <div className="site-layout-background" style={{ padding: 24 }}>
                        ...
                        <br />
                        <h3 className='text-primary'>Courier Details 
                            {props.auth && props.auth.admin_role && //<===Order update courier role check
                                props.auth.admin_role.order_record_invoice &&
                ...
                <Grid.Column mobile={16} tablet={16} computer={4}>
                    ...
                    <div className="site-layout-background" style={{ padding: 24 }}>
                        ...
                        {props.auth && props.auth.admin_role && //<===Order update payment role check
                            props.auth.admin_role.order_record_update_paymentinfo &&
                    ...
                    <div className="site-layout-background" style={{ padding: 24 }}>
                        ...
                        {props.auth && props.auth.admin_role && //<===Order update shipping role check
                            props.auth.admin_role.order_record_update_billingshipping &&
