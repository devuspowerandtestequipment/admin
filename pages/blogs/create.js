...
export const Create = (props) => {
    ...
    const [data,setData]=useState({name:'',url:'',content:'',image:false,readtime:'0',meta_title:'',meta_description:'',meta_keyword:''})
    ...
    const handleSubmit=()=>{
      ...
      axios.post(`${process.env.backendURL}/blog`,data)
      .then(response=>{
...
export default connect(mapStateToProps, {fetchBlogs})(Create)